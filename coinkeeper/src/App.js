...
function App() {
    ...
    function addIncomeTransaction(date, amount: number, account, income) {
        if (date && !isNaN(amount) && account && income) {
            let newTransactions = [...userInfo.incomeTransactionList || [], createIncomeTransaction(date, amount, account, income)]
            const newUserInfo = {
                ...userInfo,
    ...
    function addOutcomeTransaction(date, amount: number, account, expense) {
        if (date && !isNaN(amount) && account && expense) {
            let newTransactions = [...userInfo.expenseTransactionList || [], createOutcomeTransaction(date, amount, account, expense)]
            const newUserInfo = {
                ...userInfo,
